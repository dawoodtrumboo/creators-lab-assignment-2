...
const Footer = () => {
  return (
    ...
    <div className=' px-[20px] pt-[80px] md:pt-[140px] relative z-30  md:flex md:justify-between'>
        ...
        Primefort is a global provider of IT security solutions that solve real 
        business issues. Our dedicated team of security engineers offers solutions 
        to customers throughout the world for securing innovations.
        </p>
        </div>
        ...
        <div className='text-xs'>
            <h1 className='text-[#3846C5] font-bold'>Headquaters</h1>
